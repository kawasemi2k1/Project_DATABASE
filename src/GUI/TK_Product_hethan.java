 ...
 * @author MyPC
 */
public class TK_Product_hethan extends javax.swing.JFrame {

    /**
     * Creates new form TK_Product_hethan
     */
    public TK_Product_hethan() {
        ...
        jcontent.removeAll();
        jcontent.add(frm, "Thống kê nhãn hàng");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TK_Product_hethan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TK_Product_hethan().setVisible(true);
            }
        });
    }
